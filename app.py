    ...
    try:
        with st.spinner("Đang tạo biên bản..."):
            ...
            for k, v in user_data.items():
                ...
                # 4) Parse date-like ONLY IF not money AND key ∉ DATE_KEYS
                if (key_norm not in DATE_KEYS) and (not is_likely_money_key(key_norm)):
